<div class="texts index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $text['Text']['content']; ?>&nbsp;</td>
		<td><?php echo $text['Text']['created']; ?>&nbsp;</td>
		<td><?php echo $text['Text']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $text['Text']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $text['Text']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $text['Text']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $text['Text']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
